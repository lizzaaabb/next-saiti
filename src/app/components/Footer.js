        ...
        <div className="ftr-cols">
          <div className="ftr-col">
            ...
            <nav aria-label="Footer ნავიგაცია" >
              <Link href="/" className="ftr-link">მთავარი</Link>
              <Link  href="/saitis-damzadeba-proeqtebi" className="ftr-link">პროექტები</Link>
              <Link href="/saitis-damzadeba-fasebi" className="ftr-link">საიტის ფასები</Link>
              <Link href="/saitis-ackoba-kontaqti" className="ftr-link">კონტაქტი</Link>
            </nav>
          </div>
